...
if (empty($_SESSION['email'])) {
	...
	$id = "";
	$nom = "";
	$objControlSubseccion = new ControlSubseccion(null);
	$arregloSubseccion = $objControlSubseccion->listar();
	//var_dump($arregloSubseccion);
	...
	switch ($boton) {
		case 'Guardar':
			...
			$objControlSubseccion = new ControlSubseccion($objSubseccion);
			$objControlSubseccion->guardar();
			header('Location: vistaSubseccion.php');
			break;
		case 'Consultar':
			$objSubseccion = new Subseccion($id, "");
			$objControlSubseccion = new ControlSubseccion($objSubseccion);
			$objSubseccion = $objControlSubseccion->consultar();
			$nom = $objSubseccion->getNombre();
			break;
		case 'Modificar':
			$objSubseccion = new Subseccion($id, $nom);
			$objControlSubseccion = new ControlSubseccion($objSubseccion);
			$objControlSubseccion->modificar();
			header('Location: vistaSubseccion.php');
			break;
		case 'Borrar':
			$objSubseccion = new Subseccion($id, "");
			$objControlSubseccion = new ControlSubseccion($objSubseccion);
			$objControlSubseccion->borrar();
			header('Location: vistaSubseccion.php');
			break;
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Gestión <b>Subsección</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión Subsección</span></a>
...
<div id="crudModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="vistaSubseccion.php" method="post">
				<div class="modal-header">						
					<h4 class="modal-title">Subsección</h4>
