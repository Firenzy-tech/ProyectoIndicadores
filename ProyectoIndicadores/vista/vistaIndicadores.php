<?php
	...
	switch ($boton) {
		case 'Guardar':
			$objIndicadores = new Indicador($id, $cod, $nom, $objt, $alc, $for, $fkidtpindic, $fkidunimedi, $met, $fkidsenti, $fkidartic, $fkidliter, $fkidnumer, $fkidparag, $fkidfrecu);
			...
			<form action="vistaIndicadores.php" method="post">
				...
				<div class="container">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu1">Representación Visual</a>
							</li>
							<li class="nav-item">
