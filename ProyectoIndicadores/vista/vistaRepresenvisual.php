...
if (empty($_SESSION['email'])) {
	...
	//var_dump($arregloRepresenvisual);
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Gestión <b>Representación visual</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión Representación visual</span></a>
			...
			<form action="vistaRepresenvisual.php" method="post">
				...
				<div class="modal-body">			
					...
					<div class="form-group" id="campoNombreModal">
						<label>Nombre Representación visual</label>
